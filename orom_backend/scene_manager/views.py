...
class MujocoSimulationStart(APIView):
    ...
    def post(self, request):
        ...
        try:
            # Build image if it does not 
            dockerfile_path = os.path.join(self.base_dir, "mvp_mujoco_simulation", "docker")
            build_mujoco_image(self.image_name, dockerfile_path, self.dockerfile_name)
